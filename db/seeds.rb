...
Location.create!(name:"A secret garden", user: User.all.sample, address: "Karl Johans gate 12, Oslo", price: "299", description:"Enact a romantic rendesvouz or dramatic meeting in our wellkept walled garden, complete with statues")
loc = Location.last
...
Location.create!(name:"Modest home", user: User.all.sample, address: "Tørvebryggen 11, randers", price:"99", description: "Get the authentic crack den experience that only a real crack den offers! Only available for a limited period!")
